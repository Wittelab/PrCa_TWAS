...
def Main():
  dbName = '/wittelab/data2/emamin/TWAS/ReviewerResponses/TCGAImputation/dbs/Prostate_Thibodeau.1MbpWindowSize.db'
  ...
  betaPath = "/wittelab/data2/emamin/TWAS/ReviewerResponses/TCGAImputation/WindowSizeComparison/AllBetas/*enet.betas.txt"
  enetBetaFiles = [globName for globName in glob.glob(betaPath)]

  moreBetaPath = "/wittelab/data2/emamin/TWAS/ReviewerResponses/TCGAImputation/WindowSizeComparison/AllBetas/*enet.betas.txt"
  enetBetaFiles += [globName for globName in glob.glob(moreBetaPath)]
